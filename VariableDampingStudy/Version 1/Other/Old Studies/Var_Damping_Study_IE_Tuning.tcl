...
set gravity 0; set g 0; set c 0; set j 0; set stiff 0; set damp 0; set grav 0; set trialno 0; set waittime 0; set plswait 0
set pauseno 0; set trialtime 0; set e 0; set d 0; set b 0; set q 1; set calcycle 0; set targx $calx; set targy $caly
set rest 750; set bz 0; set t 40; set vel 0; set accel 0; set bh 1.0; set k 1; set v5 0; set v4 0; set v3 0; set v2 0
set v1 0; set t5 0; set t4 0; set t3 0; set t2 0; set t1 0; set maxVal -999999; set minVal 999999; set maxTime 0; set maxTime 0;
  ...
  if { $bz == 0} {
    if { $stableMode == 0 } {
      ...
      #puts $graphMatrix
        ...
        set damp [ expr { ( $bh * (-1) ) / (1 + exp( (-1) * $avg_k *$vel * $accel) ) + 0.85 } ]
         .c delete theDamp
  ...
  if { $n > $RAND } {
    ...
    if { $q < $rest } {
      ...
      source /home/imt/imt/robot4/protocols/ankle/Graph/tcl/graph.tcl
		...
		if {$trialno == 11 || $trialno == 21 || $trialno == 31 || $trialno == 41 || $trialno == 51 || $trialno == 61} {
			set avg_k 1
      ...
      puts "Trial $trialno of 111 complete"
      .c delete theTrial
      .c create text [ expr { 0 * $pi / 180 * $scale } ] [ expr { -8 * $pi / 180 * $scale } ] -text "Trial $trialno of 111 complete" -font [list Helvetica 40] -tags theTrial
      #	puts $vecpos
      #	puts $stablevecpos
      if { $trialno == 11 } {
        puts "Trial $trialno of 111 complete"
        puts "End of no damping trials"
        .c delete theTrial
      .c create text [ expr { 0 * $pi / 180 * $scale } ] [ expr { -8 * $pi / 180 * $scale } ] -text "Trial $trialno of 111 complete" -font [list Helvetica 40] -tags theTrial
        wshm ankle_stiff_IE 200.0
        wshm ankle_gravityTorque $gravity
